...
${DOCKER_RUN} custom-k6 run \
  ...
  --stage 0s:0,1s:1,\
20s:1,10s:10,30s:10,10s:20,30s:20,10s:30,1m:30,10s:20,30s:20,10s:10,30s:10,20s:1,1m:1,\
20s:1,10s:10,30s:10,10s:20,1m:20,10s:10,30s:10,20s:1,1m:1,\
20s:1,10s:10,1m:10,20s:1,1m:1,\
1m:1 \
scripts/sac.js
